...
# PROBLEM 1. Write a string method call that lower cases all
    ...
    occur=0#problem 5
    l = [item.lower() for item in wordList]
    for word in l:
        occur+= List.count(word)
    ...
    return (occur/len(List))#problem 6
...
print(litCricFriend(['A','an'],theBells))#problem 7
...
# differently?
'''#problem 8
# Poe's indefinite frequency / Neruda's indefinite frequency: 4% / 0.7%
# Poe's definite frequency / Neruda's definte frequency: 16.6% to 5.9%
'''
